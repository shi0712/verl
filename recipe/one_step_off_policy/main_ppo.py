...
class OneStepTaskRunner:
    def run(self, config):
        # Ensure W&B credentials are available inside the Ray worker process.
        # Ray workers may not inherit env vars exported in the shell script,
        # so we FORCE set them here before wandb.init is called.
        os.environ["WANDB_API_KEY"] = "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"
        os.environ["WANDB_ENTITY"] = "echo2"
